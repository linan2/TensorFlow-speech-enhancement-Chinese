...
python2.7 pre_process_data.py calculate_train_features --train_speech_path="data/tr/inputs.txt" --data_type=train
python2.7 pre_process_data.py calculate_train_features --train_speech_path="data/cv/inputs.txt" --data_type=cv
