...
from tfrecords_dataset import get_batch, get_padded_batch
...
def main():
    ...
    with tf.Graph().as_default():
        ...
        inputs, labels = get_batch(
            tfrecords_lst, FLAGS.batch_size, FLAGS.input_dim,
            FLAGS.output_dim, 0, 0, num_threads=FLAGS.num_threads,
            num_epochs=FLAGS.num_epochs, infer=False)
        # inputs.set_shape([FLAGS.batch_size, FLAGS.input_dim * 3])
        # print(inputs.get_shape().as_list())
        # utt_id, inputs, lengths = get_batch(
        #     tfrecords_lst, FLAGS.batch_size, FLAGS.input_dim,
        #     FLAGS.output_dim, 3, 3, num_threads=FLAGS.num_threads,
