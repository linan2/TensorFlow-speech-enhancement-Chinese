...
def convert_cmvn_to_numpy(inputs_cmvn, save_dir):
    """Convert global binary ark cmvn to numpy format."""

    print("Convert %sto Numpy format" % (inputs_cmvn))
...
if __name__ == '__main__':
    ...
    convert_cmvn_to_numpy(FLAGS.inputs, FLAGS.save_dir)
